...
###########################################################################################
## Arquivo: Nó Controlador de Base V3 (Atualização de Pose)
...
###########################################################################################
    ...
    def initial_pose(self, initial_pose):

        """Callback do tópico 'initialpose'."""

        # Recebimento de uma pose enviada manualmente via rviz

        orientation = initialpose.orientation

        (row, pitch, yaw) = tf.transformations.euler_from_quaternion([orientation.x,
                                                                      orientation.y,
                                                                      orientation.z,
                                                                      orientation.w])
